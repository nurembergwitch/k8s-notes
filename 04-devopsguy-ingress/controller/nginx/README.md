...
[Kubernetes NGINX documentation](https://kubernetes.github.io/ingress-nginx/) </br>

[GitHub Repo](https://github.com/kubernetes/ingress-nginx/) with a compatibility matrix </br>

### Get the installation YAML

The controller can be installed as yaml or a helm chart (yaml way in my docs). </br>
...
> ./kubernetes_shit/my-epic-nginx-ingress.${APP_VERSION}.yaml
```
...
kubectl apply -f ./kubernetes_shit/my-epic-nginx-ingress.${APP_VERSION}.yaml
```
